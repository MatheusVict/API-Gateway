...
export class ChallengesService {
  ...
  async createChallenge(challenge: CreateChallengesDTO): Promise<void> {
  ...
  async getCategories(idplayer: string): Promise<any> {
    if (idplayer) {
  ...
  async updateChallenge(
    idchallenge: string,
    challengeBody: UpdateChallengeDTO,
  ) {
  ...
  async assignChallengeToMatch(
    challengeId: string,
    challengeToMatch: AddChallengeForMatch,
  ) {
    const challenge: ChallengeInterface = await firstValueFrom(
      this.clientChllenges.send('consultar-desafio', {
        idplayer: '',
  ...
  async deleteChallenge(idchallenge: string) {
    const challenge: ChallengeInterface = await firstValueFrom(
